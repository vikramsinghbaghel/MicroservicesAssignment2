...
public class RequestedItems {
	 ...
	 * "RequestedItems [requestedItemId=" + requestedItemId + ", requestedItemType="
	 * + requestedItemType + ", requestedItemName=" + requestedItemName +
	 * ", description=" + description + ", receiverAddress=" + receiverAddress +
	 * ", receiverContactDetails=" + receiverContactDetails + "]"; }
	 */
